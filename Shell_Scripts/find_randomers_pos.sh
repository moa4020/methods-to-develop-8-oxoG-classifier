...
#SBATCH -J find_randomers_pos
#SBATCH -p scu-cpu
#SBATCH -e /athena/cayuga_0003/scratch/moa4020/scripts/err/find_randomers_pos_%j.err
#SBATCH -o /athena/cayuga_0003/scratch/moa4020/scripts/out/find_randomers_pos_%j.out
#SBATCH -t 7-00:00:00
...
paste "$RandomerIndex" MappedRowStrings_pos.txt > RandomerIndex_MappedPos.tab
