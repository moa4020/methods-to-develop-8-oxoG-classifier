...
sequence = "TACCACAAACNNNNNNG" # Insert the degenerate DNA/RNA sequence in the standard form here

code_file_c1 = open("/athena/cayuga_0003/scratch/moa4020/8-oxoG/degenerateRef/Degenerate_sequences_left.fasta", "w")# Create a fasta file to save all the possible combinations for the degenerate DNA or RNA sequence
code_file_c1 = open("/athena/cayuga_0003/scratch/moa4020/8-oxoG/degenerateRef/Degenerate_sequences_left.fasta", "a") 
