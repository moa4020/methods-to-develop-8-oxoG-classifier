...
#SBATCH -J splitGTF_v03
#SBATCH -p scu-gpu
#SBATCH -e /athena/cayuga_0003/scratch/moa4020/scripts/err/splitGTF_v03_%j.err
#SBATCH -o /athena/cayuga_0003/scratch/moa4020/scripts/out/splitGTF_v03_%j.out
#SBATCH -t 7-00:00:00
