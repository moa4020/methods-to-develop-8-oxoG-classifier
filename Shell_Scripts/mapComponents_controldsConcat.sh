...
#SBATCH -p scu-cpu
#SBATCH -e /athena/cayuga_0003/scratch/moa4020/scripts/err/mapComponents_controldsConcat_%j.err
#SBATCH -o /athena/cayuga_0003/scratch/moa4020/scripts/out/mapComponents_controldsConcat_%j.out
#SBATCH -t 7-00:00:00
...
inDir="/athena/cayuga_0003/scratch/moa4020/8-oxoG/basecalls/control/withEndPrep/seqkit_filtered_datasets"

#fastqName="modLib_trimmed_filtered_m45-M4000.fastq"
fastaName="dsConcat_wEndPrep_m40-M4000.fasta"
...
outDir="/athena/cayuga_0003/scratch/moa4020/8-oxoG/motifsearch/control"
