...
#SBATCH -J find_randomers_ACT_neg
#SBATCH -p scu-cpu
#SBATCH -e /athena/cayuga_0003/scratch/moa4020/scripts/err/find_randomers_ACT_neg_%j.err
#SBATCH -o /athena/cayuga_0003/scratch/moa4020/scripts/out/find_randomers_ACT_neg_%j.out
#SBATCH -t 7-00:00:00
...
paste "$RandomerIndex" MappedRowStrings_neg.txt > RandomerIndex_MappedNeg_ACT.tab
