...
#SBATCH -J splitFeatureFiles_LA
#SBATCH -p scu-cpu
#SBATCH -e /athena/cayuga_0003/scratch/moa4020/scripts/err/splitFeatureFiles_LA_%j.err
#SBATCH -o /athena/cayuga_0003/scratch/moa4020/scripts/out/splitFeatureFiles_LAc_%j.out
#SBATCH -t 7-00:00:00
...
outDir="/athena/cayuga_0003/scratch/moa4020/8-oxoG/motifsearch/modified/featureWiseGTF/LA_split"
inFileName="modLib_trimmed_filtered_m45-M4000_seqkit.locate_LA.gtf"
...
uniqueReadsFilePath="$inDir/uniqueReads_LA.txt"
